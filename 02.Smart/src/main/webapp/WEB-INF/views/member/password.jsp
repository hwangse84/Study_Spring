...
$("#btn-change").click(function(){
	//입력이 잘 되어져있는지 확인 후 DB에 변경저장	
	if( tagIsValid() ){
		//alert("OK")
		//현재비번이 DB의 현재비번과 일치하는지 확인
// 		$.ajax({
// 			url: "confirmPassword",
...
function resetPassword(){
	$.ajax({
		...
		if( response )	{ alert("비밀번호 변경되었습니다"); location = "<c:url value='/'/>" }
		else 			alert("비밀번호 변경 실패ㅠㅠ")
	})
}
