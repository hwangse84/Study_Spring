...
<div>이메일: <input type="text" id="email" value="snow@naver.com"> </div>
<div>전화번호: <input type="text" id="phone" value="010-9234-2972"> </div>
...
<div>이메일: <input type="text" name="email" value="new@naver.com"></div>
<div>주소: <input type="text" name="address" value="광주 광산구 원전동"></div>
<div>우편번호: <input type="text" name="post" value="182-237"></div>
<div>전화번호: <input type="text" name="phone" value="010-2735-2736"></div>
<div>생년월일: <input type="text" name="birth" value="2013-09-28"></div>
